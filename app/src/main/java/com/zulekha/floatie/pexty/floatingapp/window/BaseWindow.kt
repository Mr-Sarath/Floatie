package com.zulekha.floatie.pexty.floatingapp.window
...
import com.zulekha.floatie.R
import com.zulekha.floatie.pexty.floatingapp.FloatingObject
import com.zulekha.floatie.pexty.floatingapp.FloatingPermissions
import com.zulekha.floatie.pexty.utils.BitmapUtil
import com.zulekha.floatie.pexty.utils.ColorUtil
import com.zulekha.floatie.pexty.utils.Utils
...
open class BaseWindow constructor(
    ...
    protected val contentContainerView = CardView(context).apply {
        ...
        setOnTouchListener { _, e ->
            onTouchContentListener != null && onTouchContentListener!!.onTouch(
                this@BaseWindow,
                e
            )
        }
    ...
    var minWidth: Int
        ...
        set(value) {
            _minWindth =
                min(max(actionBarHeight * 3, value), context.resources.displayMetrics.widthPixels)
    ...
    var minHeight: Int
        ...
        set(value) {
            _minHeight =
                min(max(actionBarHeight * 2, value), context.resources.displayMetrics.heightPixels)
    ...
    var width: Int
        ...
        set(value) {
            ...
            floatingObject.width =
                min(max(_minWindth, value), context.resources.displayMetrics.widthPixels)
            scaleAnchorView.x =
                floatingObject.width - actionBarHeight - Utils.DPtoPixels(context, 4)
        }
    ...
    var height: Int
        ...
        set(value) {
            ...
            floatingObject.height =
                min(max(_minHeight, value), context.resources.displayMetrics.heightPixels)
            scaleAnchorView.y =
                floatingObject.height - actionBarHeight - Utils.DPtoPixels(context, 4)
        }
